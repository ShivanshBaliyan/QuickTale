...
import { BlogContext } from "../pages/pages";
...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setIsReplying }) => {
    ...
    const handleComment = () => {
        if(!access_token) {
            return toast.error("Log in to post a comment.");
        }
    ...
    return (
        <>
            ...
            <textarea
                ...
                className="input-box !pl-5 placeholder:text-gray-600 resize-none h-[150px] overflow-auto">
            </textarea>
