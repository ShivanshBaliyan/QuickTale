...
import { InputBox, Loader } from "../components/index";
import { profileDataStructure } from "./profile-page";
import { Toaster, toast } from "react-hot-toast";
import { uploadImage, storeInSession } from "../common/common";
...
const EditProfile = () => {
    ...
    const [charatersLeft, setCharactersLeft] = useState(bioLimit);
    const [updatedProfileImg, setUpdatedProfileImg] = useState(null);

    // defensive destructuring: profile may be { user: {...} } from API or missing fields
    ...
    useEffect(() => {
        if(access_token) {
            ...
            .then(({ data }) => {
                // API returns { user: {...} } — prefer that; fall back to whole payload
