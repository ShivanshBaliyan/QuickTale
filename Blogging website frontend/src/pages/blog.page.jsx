...
import { AnimationWrapper, getDay } from '../common/common'
import { Loader, BlogInteraction, BlogPostCard, BlogContent, CommentsContainer } from '../components/index'
...
const BlogPage = () => {
  ...
  const fetchBlog = () => {
    ...
    .then(async({ data: { blog } }) => {
      ...
      // Fetch similar blogs based on tags
          ...
          <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
            ...
            <div className="mt-12">
              ...
              <div className="flex max-sm:flex-col justify-between my-8">
                ...
                <p className="text-gray-800/75 max-sm:mt-6 max-sm:ml-12 max-sm:pl-5" >Published on {getDay(publishedAt)}</p>
              </div>
